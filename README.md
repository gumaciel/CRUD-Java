...
- Baixe e execute o Script SQL: [crud_java.sql](https://www31.zippyshare.com/d/7ytgJGCA/42290/crud_java.sql) ou [crud_java.sql](https://github.com/gustavottc/CRUD-JAVA-WEB/blob/master/crud_java.sql)
